...
- У каждого проекта должны быть понятные рельсы для иттерацеонного улучшения
...
- Высчет диффецити и профицита по гаждому участнику исходя из коэффициента выполненных задач

### Индустриальный стандарт
- Поддержка со стороны социальных организаций (Для государств не имеющих возможность минимальные привлечь инвестиции как для запуска собственного дела так и для выхода на глобальный рынок) @Muhammad Unus
- Государственные субсидии (для государств люди которого не имеют возможность найти быть самозанятыми и найти применение своим навыкам) цитата @Mark Zuckerberg
