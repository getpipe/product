...
- Паралельное комьюнити без точек соприкосновение
- Задачи в холостую (тестовые)
- Дублирование инструментариев (Киты, библиотеки, ...)
- По многим отрослям отстутвует опенсорс (Редакторы и дизайнеры)
...
- Позволить получать экспертизу на сформированную потребность
